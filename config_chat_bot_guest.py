...
def get_dialog_manager(user_info={}):
    ...
    """
    Тебе необходимо классифицировать обращение пользователя по одному из 6 вариантов. Первые 5 относятся к вопросам про бизнес, всё остальное нужно относить к 6 классу
    ...
    dummy_get_more_info_land = {"id": "dummy_get_more_info_land",
                               "type": DummyListFormatter, 
                               "key": "unparsed_enities",
                               "format_ans": 'Пожалуйста, укажите следующую информацию:\n{info_list}',
